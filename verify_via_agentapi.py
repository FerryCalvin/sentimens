...
def process_file(input_path, output_path, restart=False, start_idx=None, end_idx=None):
    ...
    if start_idx is not None or end_idx is not None:
        ...
        print(f"Slicing dataset from row {start_idx} to {end_idx}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--start", type=int, default=None, help="Start row index")
    ...
    if args.file == "valid":
        ...
        process_file(in_path, out_path, restart=args.restart, start_idx=args.start, end_idx=args.end)
    elif args.file == "train":
        in_path = os.path.join(datasets_dir, "FINAL_TRAIN.csv")
        if args.start is not None or args.end is not None:
            out_name = f"FINAL_TRAIN_verified_{args.start}_{args.end}.csv"
        else:
            out_name = "FINAL_TRAIN_verified.csv"
